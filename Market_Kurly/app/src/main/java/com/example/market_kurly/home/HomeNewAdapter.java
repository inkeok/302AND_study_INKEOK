...
public class HomeNewAdapter extends BaseAdapter {
    ...
    public HomeNewAdapter(LayoutInflater inflater, ArrayList<PrizeDTO> new_list, Activity context) {
    ...
    public View getView(int i, View c, ViewGroup parent) {
        ...
        if(new_list.get(i).isBool_sale()){
           menu_small_pic.setImageResource(new_list.get(i).getPic());
           menu_small_name.setText(new_list.get(i).getName());
           menu_small_sale.setVisibility(View.VISIBLE);
           menu_small_salePer.setVisibility(View.VISIBLE);
           menu_small_sale.setText(new_list.get(i).getSale()+"");
           menu_small_realPrice.setText(df.format(new_list.get(i).getPrice() * (100 -new_list.get(i).getSale())/100/10*10));
           menu_small_price.setVisibility(View.VISIBLE);
           menu_small_pricePer.setVisibility(View.VISIBLE);
           menu_small_price.setText(df.format(new_list.get(i).getPrice()));
           ...
           menu_small_pricePer.setPaintFlags(menu_small_pricePer.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
            ...
            menu_small_realPrice.setText(df.format(new_list.get(i).getPrice()));
